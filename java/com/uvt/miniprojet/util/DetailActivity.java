package com.uvt.miniprojet.util;
...
import com.uvt.miniprojet.util.layout.TrackingScrollView;
...
public abstract class DetailActivity extends AppCompatActivity {
    ...
    private static int blendColors(float ratio, Context c) {
        int color1 = ContextCompat.getColor(c, R.color.myPrimaryDarkColor); //myPrimaryDarkColor
